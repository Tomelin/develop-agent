...
func defaultAgentSpecs() []seedSpec {
	return []seedSpec{
		...
		{"Planejador de Roadmap", "Quebra escopo em épicos e tarefas", agent.ProviderOpenAI, "gpt-4o", []string{"Converta arquitetura em backlog técnico executável."}, []agent.Skill{agent.SkillPlanning}, "provider-openai-default"},
